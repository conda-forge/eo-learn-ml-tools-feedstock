...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8656&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eo-learn-ml-tools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eo-learn-ml-tools` can be installed with:

```
conda install eo-learn-ml-tools
```

It is possible to list all of the versions of `eo-learn-ml-tools` available on your platform with:
